...
public class PlayerController : MonoBehaviour
{
    ...
    private Vector2 _lastDirection = Vector2.down;      // Dernière direction empruntée par le joueur
    ...
    public void StartRoll()
    {
        ...
        // On envoie la progression de la roulade à l'Animator
        _animator.SetFloat("RollProgress", 0f);
    }
    public void DoRoll()
    {
        // On calcule la velocité du mouvement
        ...
        // On envoie la progression de la roulade à l'Animator
        _animator.SetFloat("RollProgress", GetRollProgress());
    }
